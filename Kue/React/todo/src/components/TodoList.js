                                    ...
                                    <div key={todo.id} style={{ background: todo.completed ? "rgb(56 56 56)" : "" }}>
                                        <div className="trackRow">
                                            ...
                                            <div className='btnRequests'>
                                                ...
                                                <button onClick={() => handleDelete(todo)} className="delete-button" style={{ background: todo.completed ? "rgb(56, 56, 56)" : "#b94142" }}><img className= "dBtn" src={declineBtn}  width ="25%" height="25%" /></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
